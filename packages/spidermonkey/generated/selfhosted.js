...
function GetMethod(V, P) {
    do { if (!(IsPropertyKey(P))) AssertionFailed("./src/builtin/Utilities.js" + ":" + 131 + ": " + "Invalid property key") } while (false);
    var func = V[P];
...
function GetBuiltinConstructor(builtinName) {
    ...
    do { if (!(ctor)) AssertionFailed("./src/builtin/Utilities.js" + ":" + 162 + ": " + `No builtin with name "${builtinName}" found`) } while (false);
    return ctor;
}
...
function SpeciesConstructor(obj, defaultConstructor) {
    do { if (!(IsObject(obj))) AssertionFailed("./src/builtin/Utilities.js" + ":" + 173 + ": " + "not passed an object") } while (false);
...
function GetTypeError(msg) {
    ...
    do { if (!(false)) AssertionFailed("./src/builtin/Utilities.js" + ":" + 207 + ": " + "the catch block should've returned from this function.") } while (false);
}
function GetInternalError(msg) {
    ...
    do { if (!(false)) AssertionFailed("./src/builtin/Utilities.js" + ":" + 216 + ": " + "the catch block should've returned from this function.") } while (false);
}
function NullFunction() {}
function CopyDataProperties(target, source, excluded) {
    do { if (!(IsObject(target))) AssertionFailed("./src/builtin/Utilities.js" + ":" + 226 + ": " + "target is an object") } while (false);
    do { if (!(IsObject(excluded))) AssertionFailed("./src/builtin/Utilities.js" + ":" + 229 + ": " + "excluded is an object") } while (false);
...
function CopyDataPropertiesUnfiltered(target, source) {
    do { if (!(IsObject(target))) AssertionFailed("./src/builtin/Utilities.js" + ":" + 258 + ": " + "target is an object") } while (false);
    if (source === undefined || source === null)
        return;
    source = ToObject(source);
    var keys = OwnPropertyKeys(source);
...
function ArrayIteratorNext() {
    ...
    do { if (!(itemKind === 0)) AssertionFailed("./src/builtin/Array.js" + ":" + 772 + ": " + itemKind) } while (false);
    result.value = index;
    return result;
}
...
function MakeIteratorWrapper(items, method) {
    do { if (!(IsCallable(method))) AssertionFailed("./src/builtin/Array.js" + ":" + 877 + ": " + "method argument is a function") } while (false);
    return {
...
function ArrayToLocaleString(locales, options) {
    do { if (!(IsObject(this))) AssertionFailed("./src/builtin/Array.js" + ":" + 911 + ": " + "|this| should be an object") } while (false);
    var array = this;
...
function ArraySpeciesCreate(originalArray, length) {
    do { if (!(typeof length == "number")) AssertionFailed("./src/builtin/Array.js" + ":" + 970 + ": " + "length should be a number") } while (false);
    do { if (!(length >= 0)) AssertionFailed("./src/builtin/Array.js" + ":" + 971 + ": " + "length should be a non-negative number") } while (false);
    if (length === -0)
        length = 0;
...
function FlattenIntoArray(target, source, sourceLen, start, depth, mapperFunction, thisArg) {
    ...
    for (var sourceIndex = 0; sourceIndex < sourceLen; sourceIndex++) {
        if (sourceIndex in source) {
            ...
            if (mapperFunction) {
                do { if (!(arguments.length === 7)) AssertionFailed("./src/builtin/Array.js" + ":" + 1174 + ": " + "thisArg is present") } while (false);
...
function GetCachedFormat(format, required, defaults) {
    do { if (!(format === "dateTimeFormat" || format === "dateFormat" || format === "timeFormat")) AssertionFailed("./src/builtin/Date.js" + ":" + 53 + ": " + "unexpected format key: please update the comment by " + "dateTimeFormatCache") } while (false);
    var formatters;
...
function bind_bindFunctionN(fun, thisArg, boundArgs) {
    do { if (!(boundArgs.length > 2)) AssertionFailed("./src/builtin/Function.js" + ":" + 237 + ": " + "Fast paths should be used for few-bound-args cases.") } while (false);
    var combiner = null;
    return function bound() {
        var newTarget;
        if (_IsConstructing()) {
...
function bind_constructFunctionN(fun, newTarget, args) {
    switch (args.length) {
      ...
      default:
        do { if (!(args.length !== 0)) AssertionFailed("./src/builtin/Function.js" + ":" + 335 + ": " + "bound function construction without args should be handled by caller") } while (false);
...
function InterpretGeneratorResume(gen, val, kind) {
    ...
    do { if (!(kind === "return")) AssertionFailed("./src/builtin/Generator.js" + ":" + 83 + ": " + "Invalid resume kind") } while (false);
    return resumeGenerator(gen, val, "return");
}
function resolveCollatorInternals(lazyCollatorData) {
    do { if (!(IsObject(lazyCollatorData))) AssertionFailed("./src/builtin/intl/Collator.js" + ":" + 11 + ": " + "lazy data not an object?") } while (false);
...
function getCollatorInternals(obj) {
    do { if (!(IsObject(obj))) AssertionFailed("./src/builtin/intl/Collator.js" + ":" + 82 + ": " + "getCollatorInternals called with non-object") } while (false);
    do { if (!(GuardToCollator(obj) !== null)) AssertionFailed("./src/builtin/intl/Collator.js" + ":" + 83 + ": " + "getCollatorInternals called with non-Collator") } while (false);
    var internals = getIntlObjectInternals(obj);
    do { if (!(internals.type === "Collator")) AssertionFailed("./src/builtin/intl/Collator.js" + ":" + 86 + ": " + "bad type escaped getIntlObjectInternals") } while (false);
...
function InitializeCollator(collator, locales, options) {
    do { if (!(IsObject(collator))) AssertionFailed("./src/builtin/intl/Collator.js" + ":" + 111 + ": " + "InitializeCollator called with non-object") } while (false);
    do { if (!(GuardToCollator(collator) != null)) AssertionFailed("./src/builtin/intl/Collator.js" + ":" + 112 + ": " + "InitializeCollator called with non-Collator") } while (false);
...
function collatorActualLocale(locale) {
    do { if (!(typeof locale === "string")) AssertionFailed("./src/builtin/intl/Collator.js" + ":" + 235 + ": " + "locale should be string") } while (false);
    var availableLocales = callFunction(collatorInternalProperties.availableLocales,
                                        collatorInternalProperties);
...
function collatorCompareToBind(x, y) {
    var collator = this;
    do { if (!(IsObject(collator))) AssertionFailed("./src/builtin/intl/Collator.js" + ":" + 331 + ": " + "collatorCompareToBind called with non-object") } while (false);
    do { if (!(GuardToCollator(collator) !== null)) AssertionFailed("./src/builtin/intl/Collator.js" + ":" + 332 + ": " + "collatorCompareToBind called with non-Collator") } while (false);
    var X = ToString(x);
    var Y = ToString(y);
...
function startOfUnicodeExtensions(locale) {
    do { if (!(typeof locale === "string")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 20 + ": " + "locale is a string") } while (false);
    do { if (!(IsStructurallyValidLanguageTag(locale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 21 + ": " + "locale is a language tag") } while (false);
    do { if (!(CanonicalizeLanguageTag(locale) === locale)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 22 + ": " + "locale is a canonicalized language tag") } while (false);
    do { if (!(std_String_fromCharCode(0x2D) === "-")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 26 + ": " + "code unit constant should match the expected character") } while (false);
    if (callFunction(std_String_charCodeAt, locale, 1) === 0x2D) {
        do { if (!(locale[0] === "x" || locale[0] === "i")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 31 + ": " + "locale[1] === '-' implies a privateuse-only or grandfathered locale") } while (false);
        return -1;
    }
...
function endOfUnicodeExtensions(locale, start) {
    do { if (!(typeof locale === "string")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 55 + ": " + "locale is a string") } while (false);
    do { if (!(IsStructurallyValidLanguageTag(locale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 56 + ": " + "locale is a language tag") } while (false);
    do { if (!(CanonicalizeLanguageTag(locale) === locale)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 57 + ": " + "locale is a canonicalized language tag") } while (false);
    do { if (!(0 <= start && start < locale.length)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 58 + ": " + "start is an index into locale") } while (false);
    do { if (!(Substring(locale, start, 3) === "-u-")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 59 + ": " + "start points to Unicode extension sequence") } while (false);
    do { if (!(std_String_fromCharCode(0x2D) === "-")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 63 + ": " + "code unit constant should match the expected character") } while (false);
...
function removeUnicodeExtensions(locale) {
    ...
    do { if (!(IsStructurallyValidLanguageTag(combined))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 105 + ": " + "recombination produced an invalid language tag") } while (false);
    do { if (!(startOfUnicodeExtensions(combined) < 0)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 107 + ": " + "recombination failed to remove all Unicode locale extension sequences") } while (false);
    return combined;
}
function getUnicodeExtensions(locale) {
    var start = startOfUnicodeExtensions(locale);
    do { if (!(start >= 0)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 117 + ": " + "start of Unicode extension sequence not found") } while (false);
    var end = endOfUnicodeExtensions(locale, start);
    return Substring(locale, start, end - start);
}
function parseLanguageTag(locale) {
    do { if (!(typeof locale === "string")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 161 + ": " + "locale is a string") } while (false);
    var index = 0;
    var token = 0;
    var tokenStart = 0;
    var tokenLength = 0;
    do { if (!(std_String_fromCharCode(0x2D) === "-" && std_String_fromCharCode(0x30) === "0" && std_String_fromCharCode(0x39) === "9" && std_String_fromCharCode(0x41) === "A" && std_String_fromCharCode(0x5A) === "Z" && std_String_fromCharCode(0x61) === "a" && std_String_fromCharCode(0x78) === "x" && std_String_fromCharCode(0x7A) === "z")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 194 + ": " + "code unit constants should match the expected characters") } while (false);
    function nextToken() {
        var type = 0b00;
    ...
    function tokenStartCodeUnitLower() {
        ...
        do { if (!((0x30 <= c && c <= 0x39) || (0x61 <= c && c <= 0x7A))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 240 + ": " + "unexpected code unit") } while (false);
        return c;
    }
    ...
    if (token !== 0b01 || tokenLength > 8)
        return null;
    do { if (!(tokenLength > 0)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 260 + ": " + "token length is not zero if type is ALPHA") } while (false);
    ...
    if (tokenLength > 1) {
        if (tokenLength <= 3) {
            ...
            do { if (!(4 <= tokenLength && tokenLength <= 8)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 301 + ": " + "reserved/registered language subtags") } while (false);
            language = tokenStringLower();
            if (!nextToken())
                return null;
        }
        ...
        {
            do { if (!(!(tokenStartCodeUnitLower() <= 0x39) || tokenStartCodeUnitLower() >= 0x30)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 332 + ": " + "token-start-code-unit <= '9' implies token-start-code-unit is in '0'..'9'") } while (false);
        ...
        while (tokenLength === 1) {
            ...
            if (singleton === 0x78)
                break;
            do { if (!(!(0x41 <= singleton && singleton <= 0x5A))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 373 + ": " + "unexpected upper-case code unit") } while (false);
    ...
    switch (localeLowercase) {
      ...
      case "zh-min-nan":
      case "zh-xiang":
        do { if (!(false)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 473 + ": " + "regular grandfathered tags should have been matched above") } while (false);
      case "en-gb-oed":
      case "i-ami":
      case "i-bnn":
      case "i-default":
...
function CanonicalizeLanguageTagFromObject(localeObj) {
    do { if (!(IsObject(localeObj))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 561 + ": " + "CanonicalizeLanguageTagFromObject") } while (false);
    var {locale} = localeObj;
    do { if (!(locale === callFunction(std_String_toLowerCase, locale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 565 + ": " + "expected lower-case form for locale string") } while (false);
    if (hasOwn(locale, langTagMappings))
        return langTagMappings[locale];
    do { if (!(!hasOwn("grandfathered", localeObj))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 572 + ": " + "grandfathered tags should be mapped completely") } while (false);
    var {
        language,
        extlang1,
        extlang2,
    ...
    if (!language) {
        do { if (!(typeof privateuse === "string")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 588 + ": " + "language or privateuse subtag required") } while (false);
        return privateuse;
    }
...
function CanonicalizeLanguageTag(locale) {
    ...
    do { if (!(localeObj !== null)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 696 + ": " + "CanonicalizeLanguageTag") } while (false);
    return CanonicalizeLanguageTagFromObject(localeObj);
}
function IsASCIIAlphaString(s) {
    do { if (!(typeof s === "string")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 705 + ": " + "IsASCIIAlphaString") } while (false);
...
function ValidateAndCanonicalizeLanguageTag(locale) {
    do { if (!(typeof locale === "string")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 719 + ": " + "ValidateAndCanonicalizeLanguageTag") } while (false);
    if (locale.length === 2 || (locale.length === 3 && locale[1] !== "-")) {
        if (!IsASCIIAlphaString(locale))
            ThrowRangeError(419, locale);
        do { if (!(IsStructurallyValidLanguageTag(locale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 731 + ": " + "2*3ALPHA is a valid language tag") } while (false);
        locale = callFunction(std_String_toLowerCase, locale);
        do { if (!(!hasOwn(locale, langTagMappings))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 738 + ": " + "langTagMappings contains no 2*3ALPHA mappings") } while (false);
        locale = hasOwn(locale, languageMappings)
                 ? languageMappings[locale]
                 : locale;
        do { if (!(locale === CanonicalizeLanguageTag(locale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 744 + ": " + "expected same canonicalization") } while (false);
        return locale;
    }
    var localeObj = parseLanguageTag(locale);
    if (localeObj === null)
...
function DefaultLocaleIgnoringAvailableLocales() {
    ...
    do { if (!(IsStructurallyValidLanguageTag(candidate))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 821 + ": " + "the candidate must be structurally valid") } while (false);
    do { if (!(startOfUnicodeExtensions(candidate) < 0)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 823 + ": " + "the candidate must not contain a Unicode extension sequence") } while (false);
    return candidate;
}
function DefaultLocale() {
    ...
    do { if (!(IsStructurallyValidLanguageTag(locale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 859 + ": " + "the computed default locale must be structurally valid") } while (false);
    do { if (!(locale === CanonicalizeLanguageTag(locale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 861 + ": " + "the computed default locale must be canonical") } while (false);
    do { if (!(startOfUnicodeExtensions(locale) < 0)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 863 + ": " + "the computed default locale must not contain a Unicode extension sequence") } while (false);
...
function addSpecialMissingLanguageTags(availableLocales) {
    ...
    do { if (!(lastDitch === "en-GB" && availableLocales.en)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 891 + ": " + "shouldn't be a need to add every locale implied by the last-" + "ditch locale, merely just the last-ditch locale") } while (false);
...
function BestAvailableLocaleHelper(availableLocales, locale, considerDefaultLocale) {
    do { if (!(IsStructurallyValidLanguageTag(locale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 952 + ": " + "invalid BestAvailableLocale locale structure") } while (false);
    do { if (!(locale === CanonicalizeLanguageTag(locale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 953 + ": " + "non-canonical BestAvailableLocale locale") } while (false);
    do { if (!(startOfUnicodeExtensions(locale) < 0)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 954 + ": " + "locale must contain no Unicode extensions") } while (false);
    var defaultLocale;
...
function UnicodeExtensionValue(extension, key) {
    do { if (!(typeof extension === "string")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1081 + ": " + "extension is a string value") } while (false);
    do { if (!(callFunction(std_String_startsWith, extension, "-u-") && getUnicodeExtensions("und" + extension) === extension)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1084 + ": " + "extension is a Unicode extension subtag") } while (false);
    do { if (!(typeof key === "string")) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1085 + ": " + "key is a string value") } while (false);
    do { if (!(key.length === 2)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1088 + ": " + "key is a Unicode extension key subtag") } while (false);
...
function ResolveLocale(availableLocales, requestedLocales, options, relevantExtensionKeys, localeData) {
    ...
    for (var i = 0; i < relevantExtensionKeys.length; i++) {
        ...
        do { if (!(typeof optionsValue === "string" || optionsValue === undefined || optionsValue === null)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1229 + ": " + "unexpected type for options value") } while (false);
        ...
        do { if (!(typeof value === "string" || value === null)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1253 + ": " + "unexpected locale data value") } while (false);
        result[key] = value;
        supportedExtension += supportedExtensionAddition;
    }
    if (supportedExtension.length > 2) {
        do { if (!(!callFunction(std_String_startsWith, foundLocale, "x-"))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1263 + ": " + "unexpected privateuse-only locale returned from ICU") } while (false);
        ...
        do { if (!(IsStructurallyValidLanguageTag(foundLocale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1278 + ": " + "invalid locale after concatenation") } while (false);
        do { if (!(foundLocale === CanonicalizeLanguageTag(foundLocale))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1282 + ": " + "same locale with extension") } while (false);
    }
...
function GetOption(options, property, type, values, fallback) {
    ...
    if (value !== undefined) {
        if (type === "boolean")
            ...
            do { if (!(false)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1393 + ": " + "GetOption") } while (false);
...
function DefaultNumberOption(value, minimum, maximum, fallback) {
    do { if (!(typeof minimum === "number" && (minimum | 0) === minimum)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1415 + ": " + "DefaultNumberOption") } while (false);
    do { if (!(typeof maximum === "number" && (maximum | 0) === maximum)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1416 + ": " + "DefaultNumberOption") } while (false);
    do { if (!(typeof fallback === "number" && (fallback | 0) === fallback)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1417 + ": " + "DefaultNumberOption") } while (false);
    do { if (!(minimum <= fallback && fallback <= maximum)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1418 + ": " + "DefaultNumberOption") } while (false);
    if (value !== undefined) {
...
function initializeIntlObject(obj, type, lazyData) {
    do { if (!(IsObject(obj))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1471 + ": " + "Non-object passed to initializeIntlObject") } while (false);
    do { if (!((type === "Collator" && GuardToCollator(obj) !== null) || (type === "DateTimeFormat" && GuardToDateTimeFormat(obj) !== null) || (type === "NumberFormat" && GuardToNumberFormat(obj) !== null) || (type === "PluralRules" && GuardToPluralRules(obj) !== null) || (type === "RelativeTimeFormat" && GuardToRelativeTimeFormat(obj) !== null))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1477 + ": " + "type must match the object's class") } while (false);
    do { if (!(IsObject(lazyData))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1478 + ": " + "non-object lazy data") } while (false);
    var internals = std_Object_create(null);
    internals.type = type;
    internals.lazyData = lazyData;
    internals.internalProps = null;
    do { if (!(UnsafeGetReservedSlot(obj, 0) === null)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1500 + ": " + "Internal slot already initialized?") } while (false);
    UnsafeSetReservedSlot(obj, 0, internals);
}
function setInternalProperties(internals, internalProps) {
    do { if (!(IsObject(internals.lazyData))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1509 + ": " + "lazy data must exist already") } while (false);
    do { if (!(IsObject(internalProps))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1510 + ": " + "internalProps argument should be an object") } while (false);
    internals.internalProps = internalProps;
    internals.lazyData = null;
}
function maybeInternalProperties(internals) {
    do { if (!(IsObject(internals))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1522 + ": " + "non-object passed to maybeInternalProperties") } while (false);
    var lazyData = internals.lazyData;
    if (lazyData)
        return null;
    do { if (!(IsObject(internals.internalProps))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1526 + ": " + "missing lazy data and computed internals") } while (false);
    return internals.internalProps;
}
function getIntlObjectInternals(obj) {
    do { if (!(IsObject(obj))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1539 + ": " + "getIntlObjectInternals called with non-Object") } while (false);
    do { if (!(GuardToCollator(obj) !== null || GuardToDateTimeFormat(obj) !== null || GuardToNumberFormat(obj) !== null || GuardToPluralRules(obj) !== null || GuardToRelativeTimeFormat(obj) !== null)) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1543 + ": " + "getIntlObjectInternals called with non-Intl object") } while (false);
    var internals = UnsafeGetReservedSlot(obj, 0);
    do { if (!(IsObject(internals))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1547 + ": " + "internals not an object") } while (false);
    do { if (!(hasOwn("type", internals))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1548 + ": " + "missing type") } while (false);
    do { if (!((internals.type === "Collator" && GuardToCollator(obj) !== null) || (internals.type === "DateTimeFormat" && GuardToDateTimeFormat(obj) !== null) || (internals.type === "NumberFormat" && GuardToNumberFormat(obj) !== null) || (internals.type === "PluralRules" && GuardToPluralRules(obj) !== null) || (internals.type === "RelativeTimeFormat" && GuardToRelativeTimeFormat(obj) !== null))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1554 + ": " + "type must match the object's class") } while (false);
    do { if (!(hasOwn("lazyData", internals))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1555 + ": " + "missing lazyData") } while (false);
    do { if (!(hasOwn("internalProps", internals))) AssertionFailed("./src/builtin/intl/CommonFunctions.js" + ":" + 1556 + ": " + "missing internalProps") } while (false);
    return internals;
}
...
function resolveDateTimeFormatInternals(lazyDateTimeFormatData) {
    do { if (!(IsObject(lazyDateTimeFormatData))) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 11 + ": " + "lazy data not an object?") } while (false);
    var internalProps = std_Object_create(null);
...
function replaceHourRepresentation(pattern, hourCycle) {
    ...
    do { if (!(hour !== undefined)) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 147 + ": " + "Unexpected hourCycle requested: " + hourCycle) } while (false);
    var resultPattern = "";
    var inQuote = false;
...
function getDateTimeFormatInternals(obj) {
    do { if (!(IsObject(obj))) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 171 + ": " + "getDateTimeFormatInternals called with non-object") } while (false);
    do { if (!(GuardToDateTimeFormat(obj) !== null)) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 172 + ": " + "getDateTimeFormatInternals called with non-DateTimeFormat") } while (false);
    var internals = getIntlObjectInternals(obj);
    do { if (!(internals.type === "DateTimeFormat")) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 175 + ": " + "bad type escaped getIntlObjectInternals") } while (false);
    var internalProps = maybeInternalProperties(internals);
    if (internalProps)
        return internalProps;
    internalProps = resolveDateTimeFormatInternals(internals.lazyData);
...
function CanonicalizeTimeZoneName(timeZone) {
    do { if (!(typeof timeZone === "string")) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 216 + ": " + "CanonicalizeTimeZoneName") } while (false);
    do { if (!(timeZone !== "Etc/Unknown")) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 219 + ": " + "Invalid time zone") } while (false);
    do { if (!(timeZone === intl_IsValidTimeZoneName(timeZone))) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 220 + ": " + "Time zone name not normalized") } while (false);
    var ianaTimeZone = intl_canonicalizeTimeZone(timeZone);
    do { if (!(ianaTimeZone !== "Etc/Unknown")) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 224 + ": " + "Invalid canonical time zone") } while (false);
    do { if (!(ianaTimeZone === intl_IsValidTimeZoneName(ianaTimeZone))) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 225 + ": " + "Unsupported canonical time zone") } while (false);
...
function DefaultTimeZone() {
    ...
    if (timeZone === null) {
        ...
        do { if (!(offset === (offset | 0))) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 262 + ": " + "milliseconds offset shouldn't be able to exceed int32_t range") } while (false);
...
function InitializeDateTimeFormat(dateTimeFormat, thisValue, locales, options, mozExtensions) {
    do { if (!(IsObject(dateTimeFormat))) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 299 + ": " + "InitializeDateTimeFormat called with non-Object") } while (false);
    do { if (!(GuardToDateTimeFormat(dateTimeFormat) !== null)) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 301 + ": " + "InitializeDateTimeFormat called with non-DateTimeFormat") } while (false);
...
function ToDateTimeOptions(options, required, defaults) {
    do { if (!(typeof required === "string")) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 655 + ": " + "ToDateTimeOptions") } while (false);
    do { if (!(typeof defaults === "string")) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 656 + ": " + "ToDateTimeOptions") } while (false);
    if (options === undefined)
        options = null;
    else
        options = ToObject(options);
...
function dateTimeFormatFormatToBind(date) {
    var dtf = this;
    do { if (!(IsObject(dtf))) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 780 + ": " + "dateTimeFormatFormatToBind called with non-Object") } while (false);
    do { if (!(GuardToDateTimeFormat(dtf) !== null)) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 781 + ": " + "dateTimeFormatFormatToBind called with non-DateTimeFormat") } while (false);
...
function resolveICUPattern(pattern, result) {
    do { if (!(IsObject(result))) AssertionFailed("./src/builtin/intl/DateTimeFormat.js" + ":" + 905 + ": " + "resolveICUPattern") } while (false);
    var i = 0;
...
function Intl_getDisplayNames(locales, options) {
    ...
    for (let i = 0; i < len; i++) {
        ...
        const name = names[i];
        do { if (!(typeof name === "string")) AssertionFailed("./src/builtin/intl/IntlObject.js" + ":" + 182 + ": " + "unexpected non-string value") } while (false);
        do { if (!(name.length > 0)) AssertionFailed("./src/builtin/intl/IntlObject.js" + ":" + 184 + ": " + "empty string value") } while (false);
...
function resolveNumberFormatInternals(lazyNumberFormatData) {
    do { if (!(IsObject(lazyNumberFormatData))) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 32 + ": " + "lazy data not an object?") } while (false);
    var internalProps = std_Object_create(null);
    ...
    if ("minimumSignificantDigits" in lazyNumberFormatData) {
        do { if (!("maximumSignificantDigits" in lazyNumberFormatData)) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 73 + ": " + "min/max sig digits mismatch") } while (false);
...
function getNumberFormatInternals(obj) {
    do { if (!(IsObject(obj))) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 90 + ": " + "getNumberFormatInternals called with non-object") } while (false);
    do { if (!(GuardToNumberFormat(obj) !== null)) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 91 + ": " + "getNumberFormatInternals called with non-NumberFormat") } while (false);
    var internals = getIntlObjectInternals(obj);
    do { if (!(internals.type === "NumberFormat")) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 94 + ": " + "bad type escaped getIntlObjectInternals") } while (false);
    var internalProps = maybeInternalProperties(internals);
    if (internalProps)
        return internalProps;
    internalProps = resolveNumberFormatInternals(internals.lazyData);
...
function SetNumberFormatDigitOptions(lazyData, options, mnfdDefault, mxfdDefault) {
    do { if (!(IsObject(options))) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 134 + ": " + "SetNumberFormatDigitOptions") } while (false);
    do { if (!(typeof mnfdDefault === "number")) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 135 + ": " + "SetNumberFormatDigitOptions") } while (false);
    do { if (!(typeof mxfdDefault === "number")) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 136 + ": " + "SetNumberFormatDigitOptions") } while (false);
    do { if (!(mnfdDefault <= mxfdDefault)) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 137 + ": " + "SetNumberFormatDigitOptions") } while (false);
...
function toASCIIUpperCase(s) {
    do { if (!(typeof s === "string")) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 169 + ": " + "toASCIIUpperCase") } while (false);
    var result = "";
    for (var i = 0; i < s.length; i++) {
        var c = callFunction(std_String_charCodeAt, s, i);
...
function IsWellFormedCurrencyCode(currency) {
    do { if (!(typeof currency === "string")) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 190 + ": " + "currency is a string value") } while (false);
    return currency.length === 3 && IsASCIIAlphaString(currency);
}
function InitializeNumberFormat(numberFormat, thisValue, locales, options) {
    do { if (!(IsObject(numberFormat))) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 207 + ": " + "InitializeNumberFormat called with non-object") } while (false);
    do { if (!(GuardToNumberFormat(numberFormat) !== null)) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 208 + ": " + "InitializeNumberFormat called with non-NumberFormat") } while (false);
...
function CurrencyDigits(currency) {
    do { if (!(typeof currency === "string")) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 332 + ": " + "currency is a string value") } while (false);
    do { if (!(IsWellFormedCurrencyCode(currency))) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 333 + ": " + "currency is well-formed") } while (false);
    do { if (!(currency == toASCIIUpperCase(currency))) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 334 + ": " + "currency is all upper-case") } while (false);
...
function numberFormatFormatToBind(value) {
    var nf = this;
    do { if (!(IsObject(nf))) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 407 + ": " + "InitializeNumberFormat called with non-object") } while (false);
    do { if (!(GuardToNumberFormat(nf) !== null)) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 408 + ": " + "InitializeNumberFormat called with non-NumberFormat") } while (false);
...
function Intl_NumberFormat_resolvedOptions() {
    ...
    do { if (!(hasOwn("currency", internals) === (internals.style === "currency"))) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 491 + ": " + "currency is present iff style is 'currency'") } while (false);
    do { if (!(hasOwn("currencyDisplay", internals) === (internals.style === "currency"))) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 493 + ": " + "currencyDisplay is present iff style is 'currency'") } while (false);
    ...
    do { if (!(hasOwn("minimumSignificantDigits", internals) === hasOwn("maximumSignificantDigits", internals))) AssertionFailed("./src/builtin/intl/NumberFormat.js" + ":" + 503 + ": " + "minimumSignificantDigits is present iff maximumSignificantDigits is present") } while (false);
...
function resolvePluralRulesInternals(lazyPluralRulesData) {
    do { if (!(IsObject(lazyPluralRulesData))) AssertionFailed("./src/builtin/intl/PluralRules.js" + ":" + 35 + ": " + "lazy data not an object?") } while (false);
    var internalProps = std_Object_create(null);
    ...
    if ("minimumSignificantDigits" in lazyPluralRulesData) {
        do { if (!("maximumSignificantDigits" in lazyPluralRulesData)) AssertionFailed("./src/builtin/intl/PluralRules.js" + ":" + 65 + ": " + "min/max sig digits mismatch") } while (false);
...
function getPluralRulesInternals(obj) {
    do { if (!(IsObject(obj))) AssertionFailed("./src/builtin/intl/PluralRules.js" + ":" + 80 + ": " + "getPluralRulesInternals called with non-object") } while (false);
    do { if (!(GuardToPluralRules(obj) !== null)) AssertionFailed("./src/builtin/intl/PluralRules.js" + ":" + 81 + ": " + "getPluralRulesInternals called with non-PluralRules") } while (false);
    var internals = getIntlObjectInternals(obj);
    do { if (!(internals.type === "PluralRules")) AssertionFailed("./src/builtin/intl/PluralRules.js" + ":" + 84 + ": " + "bad type escaped getIntlObjectInternals") } while (false);
    var internalProps = maybeInternalProperties(internals);
    if (internalProps)
        return internalProps;
    internalProps = resolvePluralRulesInternals(internals.lazyData);
...
function InitializePluralRules(pluralRules, locales, options) {
    do { if (!(IsObject(pluralRules))) AssertionFailed("./src/builtin/intl/PluralRules.js" + ":" + 107 + ": " + "InitializePluralRules called with non-object") } while (false);
    do { if (!(GuardToPluralRules(pluralRules) !== null)) AssertionFailed("./src/builtin/intl/PluralRules.js" + ":" + 108 + ": " + "InitializePluralRules called with non-PluralRules") } while (false);
...
function Intl_PluralRules_resolvedOptions() {
    ...
    do { if (!(hasOwn("minimumSignificantDigits", internals) === hasOwn("maximumSignificantDigits", internals))) AssertionFailed("./src/builtin/intl/PluralRules.js" + ":" + 255 + ": " + "minimumSignificantDigits is present iff maximumSignificantDigits is present") } while (false);
    if (hasOwn("minimumSignificantDigits", internals)) {
        _DefineDataProperty(result, "minimumSignificantDigits",
                            internals.minimumSignificantDigits);
        _DefineDataProperty(result, "maximumSignificantDigits",
...
function resolveRelativeTimeFormatInternals(lazyRelativeTimeFormatData) {
    do { if (!(IsObject(lazyRelativeTimeFormatData))) AssertionFailed("./src/builtin/intl/RelativeTimeFormat.js" + ":" + 35 + ": " + "lazy data not an object?") } while (false);
    var internalProps = std_Object_create(null);
...
function getRelativeTimeFormatInternals(obj, methodName) {
    do { if (!(IsObject(obj))) AssertionFailed("./src/builtin/intl/RelativeTimeFormat.js" + ":" + 65 + ": " + "getRelativeTimeFormatInternals called with non-object") } while (false);
    do { if (!(GuardToRelativeTimeFormat(obj) !== null)) AssertionFailed("./src/builtin/intl/RelativeTimeFormat.js" + ":" + 66 + ": " + "getRelativeTimeFormatInternals called with non-RelativeTimeFormat") } while (false);
    var internals = getIntlObjectInternals(obj);
    do { if (!(internals.type === "RelativeTimeFormat")) AssertionFailed("./src/builtin/intl/RelativeTimeFormat.js" + ":" + 69 + ": " + "bad type escaped getIntlObjectInternals") } while (false);
    var internalProps = maybeInternalProperties(internals);
    if (internalProps)
        return internalProps;
...
function InitializeRelativeTimeFormat(relativeTimeFormat, locales, options) {
    do { if (!(IsObject(relativeTimeFormat))) AssertionFailed("./src/builtin/intl/RelativeTimeFormat.js" + ":" + 93 + ": " + "InitializeRelativeimeFormat called with non-object") } while (false);
    do { if (!(GuardToRelativeTimeFormat(relativeTimeFormat) !== null)) AssertionFailed("./src/builtin/intl/RelativeTimeFormat.js" + ":" + 95 + ": " + "InitializeRelativeTimeFormat called with non-RelativeTimeFormat") } while (false);
...
function MapIteratorNext() {
    ...
    if (!done) {
        ...
        if (itemKind === 0) {
            ...
            do { if (!(itemKind === 2)) AssertionFailed("./src/builtin/Map.js" + ":" + 109 + ": " + itemKind) } while (false);
...
{
    do { if (!(newStatus >= 0 && newStatus <= 5)) AssertionFailed("./src/builtin/Module.js" + ":" + 73 + ": " + "Bad new module status in ModuleSetStatus") } while (false);
    do { if (!((module.status <= 2 && newStatus === 0) || newStatus > module.status)) AssertionFailed("./src/builtin/Module.js" + ":" + 80 + ": " + "New module status inconsistent with current status") } while (false);
...
{
    do { if (!(resolution === "ambiguous" || typeof resolution === "object")) AssertionFailed("./src/builtin/Module.js" + ":" + 181 + ": " + "Bad module resolution result") } while (false);
    return typeof resolution === "object" && resolution !== null;
}
function GetModuleNamespace(module)
{
    do { if (!(IsModule(module))) AssertionFailed("./src/builtin/Module.js" + ":" + 189 + ": " + "GetModuleNamespace called with non-module") } while (false);
    do { if (!(module.status !== 0 && module.status !== 5)) AssertionFailed("./src/builtin/Module.js" + ":" + 194 + ": " + "Bad module state in GetModuleNamespace") } while (false);
...
function ModuleNamespaceCreate(module, exports)
{
    ...
    for (let i = 0; i < exports.length; i++) {
        ...
        do { if (!(IsResolvedBinding(binding))) AssertionFailed("./src/builtin/Module.js" + ":" + 228 + ": " + "Failed to resolve binding") } while (false);
...
{
    do { if (!(IsModule(module))) AssertionFailed("./src/builtin/Module.js" + ":" + 237 + ": " + "Non-module passed to GetModuleEnvironment") } while (false);
    do { if (!(module.status >= 1)) AssertionFailed("./src/builtin/Module.js" + ":" + 240 + ": " + "Attempt to access module environement before instantation") } while (false);
    let env = UnsafeGetReservedSlot(module, 1);
    do { if (!(IsModuleEnvironment(env))) AssertionFailed("./src/builtin/Module.js" + ":" + 244 + ": " + "Module environment slot contains unexpected value") } while (false);
    return env;
}
...
function ModuleInstantiate()
{
    ...
    try {
        ...
        for (let i = 0; i < stack.length; i++) {
            let m = stack[i];
            do { if (!(m.status === 1)) AssertionFailed("./src/builtin/Module.js" + ":" + 304 + ": " + "Expected instantiating status during failed instantiation") } while (false);
            HandleModuleInstantiationFailure(m);
        }
        if (stack.length === 0)
            HandleModuleInstantiationFailure(module);
        do { if (!(module.status === 0)) AssertionFailed("./src/builtin/Module.js" + ":" + 313 + ": " + "Expected uninstantiated status after failed instantiation") } while (false);
        throw error;
    }
    do { if (!(module.status === 2 || module.status === 4 || module.status === 5)) AssertionFailed("./src/builtin/Module.js" + ":" + 322 + ": " + "Bad module status after successful instantiation") } while (false);
    do { if (!(stack.length === 0)) AssertionFailed("./src/builtin/Module.js" + ":" + 326 + ": " + "Stack should be empty after successful instantiation") } while (false);
    return undefined;
}
...
function InnerModuleInstantiation(module, stack, index)
{
    ...
    do { if (!(module.status === 0)) AssertionFailed("./src/builtin/Module.js" + ":" + 350 + ": " + "Bad module status in ModuleDeclarationInstantiation") } while (false);
    ...
    for (let i = 0; i < requestedModules.length; i++) {
        ...
        do { if (!(requiredModule.status === 1 || requiredModule.status === 2 || requiredModule.status === 4 || requiredModule.status === 5)) AssertionFailed("./src/builtin/Module.js" + ":" + 375 + ": " + "Bad required module status after InnerModuleInstantiation") } while (false);
        do { if (!((requiredModule.status === 1) === ArrayContains(stack, requiredModule))) AssertionFailed("./src/builtin/Module.js" + ":" + 379 + ": " + "Required module should be in the stack iff it is currently being instantiated") } while (false);
        do { if (!(typeof requiredModule.dfsIndex === "number")) AssertionFailed("./src/builtin/Module.js" + ":" + 381 + ": " + "Bad dfsIndex") } while (false);
        do { if (!(typeof requiredModule.dfsAncestorIndex === "number")) AssertionFailed("./src/builtin/Module.js" + ":" + 382 + ": " + "Bad dfsAncestorIndex") } while (false);
    ...
    do { if (!(CountArrayValues(stack, module) === 1)) AssertionFailed("./src/builtin/Module.js" + ":" + 396 + ": " + "Current module should appear exactly once in the stack") } while (false);
    do { if (!(module.dfsAncestorIndex <= module.dfsIndex)) AssertionFailed("./src/builtin/Module.js" + ":" + 398 + ": " + "Bad DFS ancestor index") } while (false);
...
{
    do { if (!(module.status === 1)) AssertionFailed("./src/builtin/Module.js" + ":" + 458 + ": " + "Unexpected module status in ThrowResolutionError") } while (false);
    do { if (!(kind === "import" || kind === "indirectExport")) AssertionFailed("./src/builtin/Module.js" + ":" + 461 + ": " + "Unexpected kind in ThrowResolutionError") } while (false);
    do { if (!(line > 0)) AssertionFailed("./src/builtin/Module.js" + ":" + 464 + ": " + "Line number should be present for all imports and indirect exports") } while (false);
...
{
    do { if (!(IsObject(module) && IsModule(module))) AssertionFailed("./src/builtin/Module.js" + ":" + 482 + ": " + "Non-module passed to GetModuleEvaluationError") } while (false);
    do { if (!(module.status === 5)) AssertionFailed("./src/builtin/Module.js" + ":" + 484 + ": " + "Bad module status in GetModuleEvaluationError") } while (false);
    return UnsafeGetReservedSlot(module, 4);
}
function RecordModuleEvaluationError(module, error)
{
    do { if (!(IsObject(module) && IsModule(module))) AssertionFailed("./src/builtin/Module.js" + ":" + 494 + ": " + "Non-module passed to RecordModuleEvaluationError") } while (false);
    if (module.status === 5) {
        return;
    }
...
function ModuleEvaluate()
{
    ...
    try {
        ...
        for (let i = 0; i < stack.length; i++) {
            let m = stack[i];
            do { if (!(m.status === 3)) AssertionFailed("./src/builtin/Module.js" + ":" + 534 + ": " + "Bad module status after failed evaluation") } while (false);
            RecordModuleEvaluationError(m, error);
        }
        if (stack.length === 0)
            RecordModuleEvaluationError(module, error);
        do { if (!(module.status === 5)) AssertionFailed("./src/builtin/Module.js" + ":" + 543 + ": " + "Bad module status after failed evaluation") } while (false);
        throw error;
    }
    do { if (!(module.status === 4)) AssertionFailed("./src/builtin/Module.js" + ":" + 549 + ": " + "Bad module status after successful evaluation") } while (false);
    do { if (!(stack.length === 0)) AssertionFailed("./src/builtin/Module.js" + ":" + 551 + ": " + "Stack should be empty after successful evaluation") } while (false);
    return undefined;
}
...
function InnerModuleEvaluation(module, stack, index)
{
    ...
    if (module.status === 3)
        return index;
    do { if (!(module.status === 2)) AssertionFailed("./src/builtin/Module.js" + ":" + 576 + ": " + "Bad module status in InnerModuleEvaluation") } while (false);
    ...
    for (let i = 0; i < requestedModules.length; i++) {
        ...
        do { if (!(requiredModule.status === 3 || requiredModule.status === 4)) AssertionFailed("./src/builtin/Module.js" + ":" + 600 + ": " + "Bad module status after InnerModuleEvaluation") } while (false);
        do { if (!((requiredModule.status === 3) === ArrayContains(stack, requiredModule))) AssertionFailed("./src/builtin/Module.js" + ":" + 604 + ": " + "Required module should be in the stack iff it is currently being evaluated") } while (false);
        do { if (!(typeof requiredModule.dfsIndex === "number")) AssertionFailed("./src/builtin/Module.js" + ":" + 606 + ": " + "Bad dfsIndex") } while (false);
        do { if (!(typeof requiredModule.dfsAncestorIndex === "number")) AssertionFailed("./src/builtin/Module.js" + ":" + 607 + ": " + "Bad dfsAncestorIndex") } while (false);
    ...
    do { if (!(CountArrayValues(stack, module) === 1)) AssertionFailed("./src/builtin/Module.js" + ":" + 621 + ": " + "Current module should appear exactly once in the stack") } while (false);
    do { if (!(module.dfsAncestorIndex <= module.dfsIndex)) AssertionFailed("./src/builtin/Module.js" + ":" + 625 + ": " + "Bad DFS ancestor index") } while (false);
    if (module.dfsAncestorIndex === module.dfsIndex) {
        let requiredModule;
        do {
            requiredModule = callFunction(std_Array_pop, stack);
...
function ObjectGetOwnPropertyDescriptor(obj, propertyKey) {
    ...
    do { if (!(attrsAndKind & 0x200)) AssertionFailed("./src/builtin/Object.js" + ":" + 184 + ": " + "expected accessor property descriptor") } while (false);
    return {
        get: desc[1],
        set: desc[2],
        enumerable: !!(attrsAndKind & 0x01),
...
function Promise_finally(onFinally) {
    ...
    do { if (!(IsConstructor(C))) AssertionFailed("./src/builtin/Promise.js" + ":" + 25 + ": " + "SpeciesConstructor returns a constructor function") } while (false);
...
function CreateListFromArrayLikeForArgs(obj) {
    do { if (!(IsObject(obj))) AssertionFailed("./src/builtin/Reflect.js" + ":" + 11 + ": " + "object must be passed to CreateListFromArrayLikeForArgs") } while (false);
...
function AdvanceStringIndex(S, index) {
    do { if (!(typeof S === "string")) AssertionFailed("./src/builtin/RegExp.js" + ":" + 64 + ": " + "Expected string as 1st argument") } while (false);
    do { if (!(index >= 0 && index <= 0x1fffffffffffff)) AssertionFailed("./src/builtin/RegExp.js" + ":" + 67 + ": " + "Expected integer as 2nd argument") } while (false);
    var length = S.length;
    if (index + 1 >= length)
        return index + 1;
...
function RegExpGetFunctionalReplacement(result, S, position, replaceValue) {
    do { if (!(result.length >= 1)) AssertionFailed("./src/builtin/RegExp.js" + ":" + 495 + ": " + "RegExpMatcher doesn't return an empty array") } while (false);
    ...
    for (var n = 0; n <= nCaptures; n++) {
        do { if (!(typeof result[n] === "string" || result[n] === undefined)) AssertionFailed("./src/builtin/RegExp.js" + ":" + 515 + ": " + "RegExpMatcher returns only strings and undefined") } while (false);
                  ...
                  )
{
    ...
    while (true) {
        ...
        if (result === null)
            break;
        do { if (!(result.length >= 1)) AssertionFailed("./src/builtin/RegExpGlobalReplaceOpt.h.js" + ":" + 60 + ": " + "RegExpMatcher doesn't return an empty array") } while (false);
                  ...
                  )
{
    ...
    while (true) {
        ...
        if (IsObject(elemBase)) {
            ...
            if (prop !== undefined) {
                do { if (!(typeof prop === "string")) AssertionFailed("./src/builtin/RegExpGlobalReplaceOpt.h.js" + ":" + 83 + ": " + "GetStringDataProperty should return either string or undefined") } while (false);
                replacement = prop;
            } else {
                elemBase = undefined;
            }
                  ...
                  )
{
    ...
    do { if (!(result.length >= 1)) AssertionFailed("./src/builtin/RegExpLocalReplaceOpt.h.js" + ":" + 83 + ": " + "RegExpMatcher doesn't return an empty array") } while (false);
    var matched = result[0];
    var matchLength = matched.length;
...
function Substring(str, from, length) {
    do { if (!(typeof str === "string")) AssertionFailed("./src/builtin/String.js" + ":" + 132 + ": " + "|str| should be a string") } while (false);
    do { if (!(from | 0 === from)) AssertionFailed("./src/builtin/String.js" + ":" + 133 + ": " + "coercing |from| into int32 should not change the value") } while (false);
    do { if (!(length | 0 === length)) AssertionFailed("./src/builtin/String.js" + ":" + 134 + ": " + "coercing |length| into int32 should not change the value") } while (false);
...
function String_repeat(count) {
    ...
    if (!(n * S.length <= ((1 << 28) - 1)))
        ThrowRangeError(86);
    do { if (!((((1 << 28) - 1) & (((1 << 28) - 1) + 1)) === 0)) AssertionFailed("./src/builtin/String.js" + ":" + 517 + ": " + "MAX_STRING_LENGTH can be used as a bitmask") } while (false);
    n = n & ((1 << 28) - 1);
    var T = "";
    for (;;) {
        if (n & 1)
...
function SetIteratorNext() {
    ...
    if (!done) {
        ...
        if (itemKind === 1) {
            ...
            do { if (!(itemKind === 2)) AssertionFailed("./src/builtin/Set.js" + ":" + 102 + ": " + itemKind) } while (false);
...
function CountingSort(array, len, signed, comparefn) {
    do { if (!(IsPossiblyWrappedTypedArray(array))) AssertionFailed("./src/builtin/Sorting.js" + ":" + 11 + ": " + "CountingSort works only with typed arrays.") } while (false);
    if (len < 128) {
...
function SortByColumn(array, len, aux, col, counts) {
    const R = 256;
    do { if (!(counts.length === R + 1)) AssertionFailed("./src/builtin/Sorting.js" + ":" + 79 + ": " + "counts has |R| + 1 entries") } while (false);
    for (let r = 0; r < R + 1; r++) {
        counts[r] = 0;
    }
    for (let i = 0; i < len; i++) {
...
function RadixSort(array, len, buffer, nbytes, signed, floating, comparefn) {
    do { if (!(IsPossiblyWrappedTypedArray(array))) AssertionFailed("./src/builtin/Sorting.js" + ":" + 114 + ": " + "RadixSort works only with typed arrays.") } while (false);
    if (len < 512) {
        QuickSort(array, len, comparefn);
        return array;
    }
    ...
    if (floating) {
        if (buffer === null) {
            ...
            do { if (!(buffer !== null)) AssertionFailed("./src/builtin/Sorting.js" + ":" + 135 + ": " + "Attached data buffer should be reified") } while (false);
        }
...
function MergeSort(array, len, comparefn) {
    ...
    for (var windowSize = 1; windowSize < denseLen; windowSize = 2 * windowSize) {
        for (var start = 0; start < denseLen - 1; start += 2 * windowSize) {
            do { if (!(windowSize < denseLen)) AssertionFailed("./src/builtin/Sorting.js" + ":" + 305 + ": " + "The window size is larger than the array denseLength!") } while (false);
...
function Partition(array, from, to, comparefn) {
    do { if (!(to - from >= 3)) AssertionFailed("./src/builtin/Sorting.js" + ":" + 326 + ": " + "Partition will not work with less than three elements") } while (false);
...
function QuickSort(array, len, comparefn) {
    do { if (!(0 <= len && len <= 0x7FFFFFFF)) AssertionFailed("./src/builtin/Sorting.js" + ":" + 362 + ": " + "length is a positive int32 value") } while (false);
    var stack = new List();
    var top = 0;
    var start = 0;
    var end = len - 1;
...
function ViewedArrayBufferIfReified(tarray) {
    do { if (!(IsTypedArray(tarray))) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 6 + ": " + "non-typed array asked for its buffer") } while (false);
    var buf = UnsafeGetReservedSlot(tarray, 0);
    do { if (!(buf === null || (IsObject(buf) && (IsArrayBuffer(buf) || IsSharedArrayBuffer(buf))))) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 10 + ": " + "unexpected value in buffer slot") } while (false);
    return buf;
}
function IsDetachedBuffer(buffer) {
    if (buffer === null)
        return false;
    do { if (!(IsArrayBuffer(buffer) || IsSharedArrayBuffer(buffer))) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 21 + ": " + "non-ArrayBuffer passed to IsDetachedBuffer") } while (false);
...
function TypedArrayCopyWithin(target, start, end = undefined) {
    ...
    do { if (!(0 <= len && len <= 0x7FFFFFFF)) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 177 + ": " + "assumed by some of the math below, see also the other assertions") } while (false);
    var relativeTarget = ToInteger(target);
    var to = relativeTarget < 0 ? std_Math_max(len + relativeTarget, 0)
                                : std_Math_min(relativeTarget, len);
    var relativeStart = ToInteger(start);
    ...
    var final = relativeEnd < 0 ? std_Math_max(len + relativeEnd, 0)
                                : std_Math_min(relativeEnd, len);
    var count = std_Math_min(final - from, len - to);
    do { if (!(0 <= to && to <= 0x7FFFFFFF)) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 202 + ": " + "typed array |to| index assumed int32_t") } while (false);
    do { if (!(0 <= from && from <= 0x7FFFFFFF)) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 204 + ": " + "typed array |from| index assumed int32_t") } while (false);
    do { if (!(-0x7FFFFFFF - 1 <= count && count <= 0x7FFFFFFF)) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 213 + ": " + "typed array element count assumed int32_t") } while (false);
    if (count > 0)
...
function SetFromNonTypedArray(target, array, targetOffset, targetLength, targetBuffer) {
    do { if (!(!IsPossiblyWrappedTypedArray(array))) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 873 + ": " + "typed arrays must be passed to SetFromTypedArray") } while (false);
...
function SetFromTypedArray(target, typedArray, targetOffset, targetLength) {
    do { if (!(IsPossiblyWrappedTypedArray(typedArray))) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 928 + ": " + "only typed arrays may be passed to this method") } while (false);
    var res = SetFromTypedArrayApproach(target, typedArray, targetOffset,
                                        targetLength | 0);
    do { if (!(res === 0 || res === 1 || res === 2)) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 938 + ": " + "intrinsic didn't return one of its enumerated return values") } while (false);
    if (res == 0)
        return undefined;
    if (res === 2) {
...
function TypedArrayCompare(x, y) {
    do { if (!(typeof x === "number" && typeof y === "number")) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 1109 + ": " + "x and y are not numbers.") } while (false);
    if (x < y)
        return -1;
    if (x > y)
        return 1;
...
function TypedArrayCompareInt(x, y) {
    do { if (!(typeof x === "number" && typeof y === "number")) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 1137 + ": " + "x and y are not numbers.") } while (false);
    do { if (!((x === (x | 0) || x === (x >>> 0)) && (y === (y | 0) || y === (y >>> 0)))) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 1139 + ": " + "x and y are not int32/uint32 numbers.") } while (false);
    var diff = x - y;
    if (diff)
        return diff;
    return 0;
...
function TypedArraySort(comparefn) {
    ...
    var wrappedCompareFn = function(x, y) {
        ...
        if (length === 0) {
            do { if (!(PossiblyWrappedTypedArrayHasDetachedBuffer(obj))) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 1227 + ": " + "Length can only change from non-zero to zero when the buffer was detached") } while (false);
            ThrowTypeError(461);
        }
        return v;
    };
...
function IterableToList(items, method) {
    do { if (!(IsCallable(method))) AssertionFailed("./src/builtin/TypedArray.js" + ":" + 1571 + ": " + "method argument is a function") } while (false);
...
function TypedObjectGet(descr, typedObj, offset) {
  do { if (!(IsObject(descr) && ObjectIsTypeDescr(descr))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 44 + ": " + "get() called with bad type descr") } while (false);
  ...
  do { if (!(false)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 64 + ": " + "Unhandled kind: " + UnsafeGetInt32FromReservedSlot(descr, 0)) } while (false);
  return undefined;
}
function TypedObjectGetDerived(descr, typedObj, offset) {
  do { if (!(!TypeDescrIsSimpleType(descr))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 70 + ": " + "getDerived() used with simple type") } while (false);
...
function TypedObjectGetOpaque(descr, typedObj, offset) {
  do { if (!(!TypeDescrIsSimpleType(descr))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 80 + ": " + "getDerived() used with simple type") } while (false);
...
function TypedObjectGetScalar(descr, typedObj, offset) {
  ...
  do { if (!(false)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 119 + ": " + "Unhandled scalar type: " + type) } while (false);
  return undefined;
}
function TypedObjectGetReference(descr, typedObj, offset) {
  ...
  do { if (!(false)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 136 + ": " + "Unhandled scalar type: " + type) } while (false);
  return undefined;
}
function TypedObjectGetSimd(descr, typedObj, offset) {
  ...
  do { if (!(false)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 274 + ": " + "Unhandled SIMD type: " + type) } while (false);
  return undefined;
}
...
function TypedObjectSetScalar(descr, typedObj, offset, fromValue) {
  do { if (!(UnsafeGetInt32FromReservedSlot(descr, 0) === 1)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 356 + ": " + "Expected scalar type descriptor") } while (false);
  var type = UnsafeGetInt32FromReservedSlot(descr, 8);
  switch (type) {
  case 0:
  ...
  do { if (!(false)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 394 + ": " + "Unhandled scalar type: " + type) } while (false);
  return undefined;
}
function TypedObjectSetReference(descr, typedObj, offset, name, fromValue) {
  ...
  do { if (!(false)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 412 + ": " + "Unhandled scalar type: " + type) } while (false);
  return undefined;
}
function TypedObjectSetSimd(descr, typedObj, offset, fromValue) {
  ...
  switch (type) {
    ...
    case 5:
      ...
      break;
    default:
      do { if (!(false)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 513 + ": " + "Unhandled Simd type: " + type) } while (false);
  }
}
function ConvertAndCopyTo(destDescr,
                          ...
                          fromValue)
{
  do { if (!(IsObject(destDescr) && ObjectIsTypeDescr(destDescr))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 530 + ": " + "ConvertAndCopyTo: not type obj") } while (false);
  do { if (!(IsObject(destTypedObj) && ObjectIsTypedObject(destTypedObj))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 532 + ": " + "ConvertAndCopyTo: not type typedObj") } while (false);
...
function Reify(sourceDescr,
               sourceTypedObj,
               sourceOffset) {
  do { if (!(IsObject(sourceDescr) && ObjectIsTypeDescr(sourceDescr))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 545 + ": " + "Reify: not type obj") } while (false);
  do { if (!(IsObject(sourceTypedObj) && ObjectIsTypedObject(sourceTypedObj))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 547 + ": " + "Reify: not type typedObj") } while (false);
...
function TypedObjectArrayRedimension(newArrayType) {
  ...
  do { if (!(UnsafeGetInt32FromReservedSlot(oldArrayType, 3) == UnsafeGetInt32FromReservedSlot(newArrayType, 3))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 626 + ": " + "Byte sizes should be equal") } while (false);
...
function SimdProtoString(type) {
  ...
  do { if (!(false)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 663 + ": " + "Unhandled type constant") } while (false);
  return undefined;
}
function SimdTypeToLength(type) {
  ...
  do { if (!(false)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 684 + ": " + "Unhandled type constant") } while (false);
  return undefined;
}
...
function SimdFormatString(descr, typedObj) {
  ...
  do { if (!(false)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 863 + ": " + "unexpected SIMD kind") } while (false);
  return "?";
}
function DescrsEquiv(descr1, descr2) {
  do { if (!(IsObject(descr1) && ObjectIsTypeDescr(descr1))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 871 + ": " + "descr1 not descr") } while (false);
  do { if (!(IsObject(descr2) && ObjectIsTypeDescr(descr2))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 872 + ": " + "descr2 not descr") } while (false);
...
function BuildTypedSeqImpl(arrayType, len, depth, func) {
  do { if (!(IsObject(arrayType) && ObjectIsTypeDescr(arrayType))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1080 + ": " + "Build called on non-type-object") } while (false);
...
function ComputeIterationSpace(arrayType, depth, len) {
  do { if (!(IsObject(arrayType) && ObjectIsTypeDescr(arrayType))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1128 + ": " + "ComputeIterationSpace called on non-type-object") } while (false);
  do { if (!(TypeDescrIsArrayType(arrayType))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1129 + ": " + "ComputeIterationSpace called on non-array-type") } while (false);
  do { if (!(depth > 0)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1130 + ": " + "ComputeIterationSpace called on non-positive depth") } while (false);
...
function IncrementIterationSpace(indices, iterationSpace) {
  do { if (!(indices.length === iterationSpace.length)) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1160 + ": " + "indices dimension must equal iterationSpace dimension.") } while (false);
  var n = indices.length - 1;
  while (true) {
    indices[n] += 1;
    if (indices[n] < iterationSpace[n])
      return;
    do { if (!(indices[n] === iterationSpace[n])) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1168 + ": " + "Components of indices must match those of iterationSpace.") } while (false);
    indices[n] = 0;
    if (n == 0)
      return;
    n -= 1;
...
function MapUntypedSeqImpl(inArray, outputType, maybeFunc) {
  do { if (!(IsObject(outputType))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1179 + ": " + "1. Map/From called on non-object outputType") } while (false);
  do { if (!(ObjectIsTypeDescr(outputType))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1180 + ": " + "1. Map/From called on non-type-object outputType") } while (false);
  inArray = ToObject(inArray);
  do { if (!(TypeDescrIsArrayType(outputType))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1182 + ": " + "Map/From called on non array-type outputType") } while (false);
...
function MapTypedSeqImpl(inArray, depth, outputType, func) {
  do { if (!(IsObject(outputType) && ObjectIsTypeDescr(outputType))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1231 + ": " + "2. Map/From called on non-type-object outputType") } while (false);
  do { if (!(IsObject(inArray) && ObjectIsTypedObject(inArray))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1232 + ": " + "Map/From called on non-object or untyped input array.") } while (false);
  do { if (!(TypeDescrIsArrayType(outputType))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1233 + ": " + "Map/From called on non array-type outputType") } while (false);
  if (depth <= 0 || ((depth) | 0) !== depth)
    ThrowTypeError(447);
...
function ReduceTypedSeqImpl(array, outputType, func, initial) {
  do { if (!(IsObject(array) && ObjectIsTypedObject(array))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1339 + ": " + "Reduce called on non-object or untyped input array.") } while (false);
  do { if (!(IsObject(outputType) && ObjectIsTypeDescr(outputType))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1340 + ": " + "Reduce called on non-type-object outputType") } while (false);
  var start, value;
...
function FilterTypedSeqImpl(array, func) {
  do { if (!(IsObject(array) && ObjectIsTypedObject(array))) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1380 + ": " + "Filter called on non-object or untyped input array.") } while (false);
  do { if (!(typeof func === "function")) AssertionFailed("./src/builtin/TypedObject.js" + ":" + 1381 + ": " + "Filter called with non-function predicate") } while (false);
