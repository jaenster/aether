...
export const exitGraph: Record<number, number[]> = {
  // Act 1 — Blood Moor → Cold Plains → Stony Field etc.
  [Area.RogueEncampment]: [Area.BloodMoor],
  [Area.BloodMoor]: [Area.ColdPlains, Area.DenofEvil],
  [Area.ColdPlains]: [Area.StonyField, Area.BurialGrounds, Area.CaveLvl1],
  [Area.CaveLvl1]: [Area.CaveLvl2],
  [Area.BurialGrounds]: [Area.Crypt, Area.Mausoleum],
  [Area.StonyField]: [Area.UndergroundPassageLvl1, Area.Tristram],
  [Area.UndergroundPassageLvl1]: [Area.DarkWood, Area.UndergroundPassageLvl2],
  [Area.DarkWood]: [Area.BlackMarsh],
  [Area.BlackMarsh]: [Area.TamoeHighland, Area.ForgottenTower],
  ...
  [Area.TamoeHighland]: [Area.MonasteryGate],
  ...
  [Area.CanyonofMagic]: [Area.TalRashasTomb1, Area.TalRashasTomb2, Area.TalRashasTomb3, Area.TalRashasTomb4, Area.TalRashasTomb5, Area.TalRashasTomb6, Area.TalRashasTomb7],
  ...
  [Area.FlayerJungle]: [Area.LowerKurast, Area.FlayerDungeonLvl1, Area.SwampyPitLvl1],
  ...
  [Area.KurastBazaar]: [Area.UpperKurast, Area.A3SewersLvl1, Area.DisusedFane, Area.RuinedTemple],
  [Area.A3SewersLvl1]: [Area.A3SewersLvl2],
  [Area.UpperKurast]: [Area.KurastCauseway, Area.ForgottenReliquary, Area.ForgottenTemple],
  [Area.KurastCauseway]: [Area.Travincal, Area.DisusedReliquary, Area.RuinedFane],
  ...
  [Area.CrystalizedPassage]: [Area.FrozenRiver, Area.GlacialTrail],
  [Area.GlacialTrail]: [Area.DrifterCavern, Area.FrozenTundra],
  [Area.FrozenTundra]: [Area.AncientsWay],
  [Area.AncientsWay]: [Area.IcyCellar, Area.ArreatSummit],
